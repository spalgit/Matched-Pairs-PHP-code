...
<?php
    ...
    $stmt = $pdo->prepare("SELECT id_a,smirks, lhs_id, transform_id, context_id, erk_ic50,herg, solubility, mean as logd
                               from (select id_a,smirks, lhs_id, transform_id, context_id, erk_ic50, herg, mean
                               as solubility from (select id_a,smirks, lhs_id, transform_id, context_id, erk_ic50,
                               mean as herg from (SELECT mol_id_a as id_a,smirks,lhs_id, transform_id, context_id,
    ...
    $stmt = $pdo->prepare("SELECT id_b,smirks, lhs_id, transform_id, context_id, erk_ic50,herg, solubility, mean as logd
  ...
  <?php
    ...
    $stmt = $pdo->prepare("SELECT id_a,smirks, lhs_id, transform_id, context_id, chmbl_clearance,assay_type,assay_chmbl_id,
                             chmbl_herg, chmbl_F_percent,chmbl_half_life, mean as chmbl_vdss
                             from (SELECT id_a,smirks, lhs_id, transform_id, context_id, chmbl_clearance,
                              assay_type,assay_chmbl_id,chmbl_herg, chmbl_F_percent, mean as chmbl_half_life
                              from (SELECT id_a,smirks, lhs_id, transform_id, context_id, chmbl_clearance,assay_type,assay_chmbl_id,
                              chmbl_herg, mean
                              as chmbl_F_percent from (SELECT id_a,smirks, lhs_id, transform_id, context_id,
                              chmbl_clearance,assay_type,assay_chmbl_id, mean as chmbl_herg from
                              (SELECT mol_id_a as id_a,smirks,lhs_id, transform_id, context_id,
    ...
    $stmt = $pdo->prepare("SELECT id_b,smirks, lhs_id, transform_id, context_id, chmbl_clearance,assay_type,chmbl_herg, chmbl_F_percent,
                             chmbl_half_life, assay_chmbl_id,mean as chmbl_vdss
                             from (SELECT id_b,smirks, lhs_id, transform_id, context_id, chmbl_clearance,
                              assay_type,chmbl_herg, chmbl_F_percent,assay_chmbl_id, mean as chmbl_half_life
                              from (SELECT id_b,smirks, lhs_id, transform_id, context_id, chmbl_clearance,assay_type,
                              chmbl_herg,assay_chmbl_id, mean
                              as chmbl_F_percent from (SELECT id_b,smirks, lhs_id, transform_id, context_id,
                                chmbl_clearance,assay_type,assay_chmbl_id,  mean as chmbl_herg from
                              (SELECT mol_id_b as id_b,smirks,lhs_id, transform_id, context_id,
                               mean as chmbl_clearance, assay_description as assay_type, assay_chembl_id as assay_chmbl_id from
